...
const WelcomePage = () => {
  return (
    <div>
      ...
      <p style={{ textAlign: 'center' }}>Source on <a target="_blank" href="https://github.com/mountainfirefly/react-boilerplate">GITHUB</a> By <a target="_blank" href="https://github.com/mountainfirefly">Pankaj</a></p>
